...
Total runtime and the deviance information criteria (DIC) goodness-of-fit measure for model selection are available within the package using the following functions: , a list of the raw point and interval estimates for all parameters, and 
