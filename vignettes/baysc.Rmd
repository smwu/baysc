...
<p class="caption">Figure: Diagram of latent class analysis</p>
</div>
...
<p class="caption">Figure: Latent class pattern profiles</p>
</div>
...
<p class="caption">Figure: Latent class pattern profiles with custom labels</p>
</div>
...
<p class="caption">Figure: Item probabilities for each latent class pattern</p>
</div>
...
<p class="caption">Figure: Dendrogram of class separation</p>
</div>
...
<p class="caption">Figure: Latent class pattern profiles with reordered classes</p>
</div>
...
<p class="caption">Figure: Distribution of latent classes in the population</p>
</div>
...
<p class="caption">Figure: Outcome regression coefficients </p>
</div>
...
<p class="caption">Figure: Outcome regression coefficients with custom labels</p>
</div>
...
<p class="caption">Figure: Outcome probabilities for levels of a categorical covariate</p>
</div>
...
<p class="caption">Figure: Outcome probabilities for levels of two categorical covariates</p>
</div>
...
```
## Time difference of 10.97209 mins
```
...
<p class="caption">Figure: Traceplots for pi</p>
</div>
...
<p class="caption">Figure: ACF plots for pi</p>
</div>
