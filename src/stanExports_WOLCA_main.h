...
public:
  ...
  inline std::string model_name() const final { return "model_WOLCA_main"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_WOLCA_main(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_WOLCA_main_namespace::model_WOLCA_main";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_WOLCA_main_namespace::log_prob";
(void) function__;  // suppress unused var warning
        ...
        for (int i = 1; i <= n; ++i) {
          ...
          for (int k = 1; k <= K; ++k) {
            ...
            assign(log_cond_c,
              ...
              stan::math::log(pi[(k - 1)]), "assigning variable log_cond_c");
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_WOLCA_main_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"pi\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"vector\",\"length\":" << R << "}}},\"block\":\"parameters\"},{\"name\":\"theta_prod\",\"type\":{\"name\":\"matrix\",\"rows\":" << J << ",\"cols\":" << R << "},\"block\":\"transformed_parameters\"},{\"name\":\"pred_class_probs\",\"type\":{\"name\":\"array\",\"length\":" << n << ",\"element_type\":{\"name\":\"vector\",\"length\":" << K << "}},\"block\":\"generated_quantities\"},{\"name\":\"pred_class\",\"type\":{\"name\":\"array\",\"length\":" << n << ",\"element_type\":{\"name\":\"int\"}},\"block\":\"generated_quantities\"},{\"name\":\"log_cond_c\",\"type\":{\"name\":\"array\",\"length\":" << n << ",\"element_type\":{\"name\":\"vector\",\"length\":" << K << "}},\"block\":\"generated_quantities\"}]";
    return s__.str();
    } // get_constrained_sizedtypes() 
    
  inline std::string get_unconstrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"pi\",\"type\":{\"name\":\"vector\",\"length\":" << (K - 1) << "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"array\",\"length\":" << K << ",\"element_type\":{\"name\":\"vector\",\"length\":" << (R - 1) << "}}},\"block\":\"parameters\"},{\"name\":\"theta_prod\",\"type\":{\"name\":\"matrix\",\"rows\":" << J << ",\"cols\":" << R << "},\"block\":\"transformed_parameters\"},{\"name\":\"pred_class_probs\",\"type\":{\"name\":\"array\",\"length\":" << n << ",\"element_type\":{\"name\":\"vector\",\"length\":" << (K - 1) << "}},\"block\":\"generated_quantities\"},{\"name\":\"pred_class\",\"type\":{\"name\":\"array\",\"length\":" << n << ",\"element_type\":{\"name\":\"int\"}},\"block\":\"generated_quantities\"},{\"name\":\"log_cond_c\",\"type\":{\"name\":\"array\",\"length\":" << n << ",\"element_type\":{\"name\":\"vector\",\"length\":" << K << "}},\"block\":\"generated_quantities\"}]";
    return s__.str();
