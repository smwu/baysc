...
#include "stanExports_WOLCA_main.h"

RCPP_MODULE(stan_fit4WOLCA_main_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_WOLCA_main")
